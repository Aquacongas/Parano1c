...
impl MdbxStore {
    ...
    pub fn open(path: &Path) -> Result<Self, StoreError> {
        ...
        // Desktop has enough virtual address space for the 1 TiB MDBX
        // ceiling. Android processes can reject such a large mmap reservation
        // even on 64-bit devices, returning MDBX_ENOMEM before the database
        // contains any meaningful data.
        //
        // Keep the desktop geometry unchanged while using a mobile-safe
        // virtual ceiling on Android. This is only the maximum MDBX map
        // address-space reservation; it does not preallocate 64 GiB on disk.
