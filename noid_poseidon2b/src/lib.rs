...
pub use primitives::{
    ...
    hash_nullifier, hash_tx_body, Address, AuthTag, Commitment, Digest, MasterSecret, Nullifier,
...
pub mod prelude {
    pub use crate::native::{
        capacity_iv, compress, DomainTag, Poseidon2bSponge, TAG_ADDRESS, TAG_ADDRSPND,
        TAG_AUTHTAG, TAG_BLOCKHDR, TAG_COMMIT, TAG_FSCHALNG, TAG_LEAF, TAG_NULLIFIER, TAG_TXBODY,
    };
