...
pub use domain::{
    ...
    TAG_CLAIMS, TAG_COMMIT, TAG_COMPRESS, TAG_DAWTNSS, TAG_EXSTNOD, TAG_EXSTSLT, TAG_FRICHANL,
    TAG_FRISTATE, TAG_FSCHALNG, TAG_HISTCLM, TAG_HISTPRF, TAG_HISTTRN, TAG_KSCHANNL, TAG_LANECHAL,
    TAG_LEAF, TAG_OUTLEAF, TAG_POWHDR, TAG_SEGMENTTREE, TAG_TXBODY, TAG_TXROOT,
};
