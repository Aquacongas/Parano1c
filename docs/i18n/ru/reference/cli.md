...
| `--p2p-listen HOST:PORT` | Адрес приёма P2P-соединений; по умолчанию `0.0.0.0:9500` |
| `--rpc-listen HOST:PORT` | Адрес приёма JSON-RPC-соединений; по умолчанию `127.0.0.1:9501` |
...
|---|---|---|
| `--rpc URL` | `http://127.0.0.1:9501` | Адрес JSON-RPC ноды |
...
Стандартный адрес — `http://127.0.0.1:9501`. Его можно изменить переменной
