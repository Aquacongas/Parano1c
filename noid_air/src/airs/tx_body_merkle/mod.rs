...
pub use air::{
    ...
    build_tx_body_merkle_typed_trace, emit_tx_body_merkle_boundary_pin_gates,
    ...
    leaf_rate_payload_col, tx_body_merkle_column_domains,
    tx_body_merkle_column_domains_with_boundary_pins, TxBodyMerkleAir, TxBodyMerkleBoundaryPins,
    N_LEAF_RATE_PAYLOAD_COLS, N_ROUNDS, TXBODY_MERKLE_LAYOUT, TXBODY_MERKLE_LOG_ROWS,
