...
pub use airs::{
    ...
    emit_perm_public_columns, emit_sweep_balance_constraints,
    emit_sweep_balance_selector_public_columns, emit_sweep_balance_value_public_columns,
    extract_perm_output, instance_row_offset, is_full_round, BalanceGateAir, BitAdderAir,
    BitAdderCarryInitGate, BitAdderCarryNextGate, CarryInitGate, CarryNextGate, CarryRippleAir,
    FaSumGate, LinearCombinationAir, PadZeroGate, RangeGateAir, Sweep25x2BalanceGateAir,
    ...
    RANGE_GATE_N_COLS, RANGE_GATE_WORD_BITS, SPINE_LOG_ROWS, SWEEP_BALANCE_INPUTS,
