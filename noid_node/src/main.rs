...
mod tests {
    use super::{
        ...
        next_block_has_competing_parent, p2p_listen_to_multiaddr, snapshot_header_next_action,
    ...
    loop {
        ...
        match rx_item {
            ...
            Ok(NetworkEvent::HistoryStepTerminal {
                ...
                let tail_correlated =
                    snapshot_tail_terminal_inflight.is_some_and(|pending| {
