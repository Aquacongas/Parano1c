...
// Wallet core now lives in the shared noid_wallet crate.
// noid_node keeps only the daemon/RPC/chain integration layer here.
pub use noid_wallet::{builder, scanner, state};
pub use noid_wallet::{SharedWallet, WalletState};
