...
def main():
    ...
    try:
        ...
        export_dirs = sorted(
            ...
            if path.is_dir() and path.name.startswith("snapshot-v2-")
        )
        require(len(export_dirs) >= 2, f"fewer than two V2 generations persisted: {export_dirs}")
        ...
        summary.update(
            {
                ...
                "persisted_v2_generations": export_dirs,
