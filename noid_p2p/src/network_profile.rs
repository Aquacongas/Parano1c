...
//! Exact network-v2 profile advertised before a connection becomes usable.
...
const PROFILE_ID_DOMAIN: &[u8] = b"NOID/P2P/NETWORK-PROFILE/V2";
...
pub const NETWORK_WIRE_VERSION: u16 = 2;
